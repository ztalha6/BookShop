...
import 'package:bookshop/widgets/vendormyflexibleappbar.dart';
...
class VendorShowroom extends StatefulWidget {
  @override
  _VendorShowroomState createState() => _VendorShowroomState();
}

class _VendorShowroomState extends State<VendorShowroom> {
                  ...
                  slivers: <Widget>[
                    SliverAppBar(
                      ...
                      flexibleSpace: FlexibleSpaceBar(
                        background: VendorMyFlexiableAppBar(),
                      ),
                    ),
                    SliverList(
