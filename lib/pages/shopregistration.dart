  ...
  Widget build(BuildContext context) {
    ...
    return IntroductionScreen(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 10),
                          buildTextField('City', Icons.location_city_rounded,
                              cityController)
                        ],
                      ),
                    ),
                ...
                child: CircleAvatar(
                  ...
                  child: _image != null
                      ...
                      : Container(
                          ...
                          buildTextField(
                              'Shop name', Icons.person, firstNameController),
                          SizedBox(height: 10),
                          buildTextField(
                              'Owner name', Icons.person, lastNameController),
                          SizedBox(height: 10),
                          buildTextField('Phone', Icons.phone, phoneController),
                          SizedBox(height: 10),
                          buildTextField(
      ...
      onDone: () => Navigator.of(context).pushReplacement(
        MaterialPageRoute(builder: (_) => VendorShowroom()),
      ),
